...
<!-- Pagina de información al usuario sobre cookies -->
    ...
    <body>    
        ...
        <header>
            <nav class="navbar navbar-dark bg-info navbar-expand-sm">
                <div class="col-lg-2">
                    <a class="navbar-brand m-0 p-0" href="../index.php"><img src="../images/logo_horizontal.png" class="img-responsive"  alt="Logotipo On Repair" width="180px" height="auto"></a>
                </div>
