                        ...
                        <div class="modal-body bg-light justify-content-center">
                            <div class="row mt-3">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="inputNombreUsuario" id="inputNombreUsuario" placeholder="Añadir Nombre ..."  mixlength="3" maxlength="50" autofocus required> 
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6">
                                    ...
                                    <input type="email" class="form-control" name="inputEmailUsuario" id="inputEmailUsuario" placeholder="Añadir Email ..."  mixlength="4" maxlength="50" required>
                            ...
                            <div id="filaPassword" class="row mt-4 mb-4">
                                <div class="col-lg-6">
                                    ...
                                    <input type="password" class="form-control" name="inputPasswordUsuario" id="inputPasswordUsuario" placeholder="Añadir Password ..." pattern="[a-zA-Z0-9ñÑ]{4,20}" mixlength="4" maxlength="20">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="password" class="form-control" name="inputConfPassUsuario" id="inputConfPassUsuario" placeholder="Confirmar Password ..." pattern="[a-zA-Z0-9ñÑ]{4,20}"  mixlength="4" maxlength="20"> 
